...
const Nav: React.FC = () => {
  return (
    <StyledNav>
      ...
      {/*<StyledAbsoluteLink href="https://info.bollo.me" target="_blank">Analysis</StyledAbsoluteLink> */}
    ...
    <HeaderFrame>
      <RowBetween style={{ alignItems: 'flex-start'}} padding="1rem 1rem 0 1rem" >
        <HeaderElement>
          <Title href=".">
            <UniIcon>
              <img style={{ height: 40, width:"auto", marginTop:-5, marginLeft: 20 }} src={isDark ? LogoDark : Logo} alt="logo" />
            </UniIcon>
          </Title>
        </HeaderElement>
        <Nav />
