...
export function colors(darkMode: boolean): Colors {
  ...
  return {
    ...
    // text
    text1: darkMode ? '#FFFFFF' : '#000000', // Normal text
    text2: darkMode ? '#C3C5CB' : '#dda2a0', // 
    text3: darkMode ? '#6C7284' : '#888D9B',
    text4: darkMode ? '#565A69' : '#C3C5CB',
    text5: darkMode ? '#2C2F36' : '#EDEEF2',

    // backgrounds / greys
    bg1: darkMode ? '#ec423a' : '#FCFCFC', // For Page and overall background
    // bg2: darkMode ? '#2C2F36' : '#F7F8FA',
    bg2: darkMode ? '#253992' : '#F7F8FA',
    bg3: darkMode ? '#2c80ff' : '#EDEEF2', 
