...
export const BOLO = new Token(ChainId.BSC_MAINNET, '0x1921168344840d1ca5acd82e8815f24582d4ad27', 18, 'BOLO', 'BOLO')
export const BOUSD = new Token(ChainId.BSC_MAINNET, '0x60f1EBE7663386ea3a7F1B37683132740c6A11e6', 18, 'BOUSD', 'BOUSD')
...
export const T_BOLO = new Token(ChainId.BSC_TESTNET, '0xd86872A287C7c9a0ac832b20c2394E26D97C86bD', 18, 'BOLO', 'BOLO')
export const T_BOUSD = new Token(ChainId.BSC_TESTNET, '0xed0CdB9c9045013b1716931f42f64C2415d89A60', 18, 'BOUSD', 'BOUSD')
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.BSC_MAINNET]: [...WETH_ONLY[ChainId.BSC_MAINNET], BAI, B_USDT, BUSD, B_DAI, BOLO, BOUSD]
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC_MAINNET]: [...WETH_ONLY[ChainId.BSC_MAINNET], BAI, B_USDT, BUSD, B_DAI, BOLO, BOUSD],
  [ChainId.BSC_TESTNET]: [...WETH_ONLY[ChainId.BSC_TESTNET], T_USDT, T_BUSD, T_DAI, T_BOLO, T_BOUSD]
}
